...
public class BankAccountControllerTest {
    ...
    void testCreateAccount_WhenUserAuthenticated_ShouldReturn201Created() throws Exception {
    ...
    @Test
    @WithMockUser(username = "test@example.com")
    void testCreateAccountMissingFields_WhenUserAuthenticated_ShouldReturn400BadRequest() throws Exception {
